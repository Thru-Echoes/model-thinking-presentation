...
function scatterchart(chartid, wd, ht, xlab, ylab, m, r, captn, tooltipYes, trnsn, colr, opacc) {
	var width, height;
	var r = (r)?r:3
	...
	var tooltip;
	//debugger;
	var setColr = (!colr) ? "steelblue" : colr;
	var setOpac = (!opacc) ? 0.85 : opacc;
